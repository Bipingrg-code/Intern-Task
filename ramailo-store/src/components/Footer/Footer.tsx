    ...
    <footer className="bg-gray-800">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-100">
            <span className="py-2 text-2xl">Ramailo Store</span>
          </a>
          <p className="mt-2 text-sm text-gray-100">
            Air plant banjo lyft occupy retro adaptogen indego
          </p>
          <div className="flex text-gray-300 mt-4">
            <button className="bg-gray-800 inline-flex p-4 rounded-lg items-center hover:bg-gray-700 hover:text-white focus:outline-none">
              <svg
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-100 tracking-widest text-sm mb-3 flex flex-col">
              Social Media
            </h2>
            <nav className="list-none mb-10 cursor-pointer flex justify-between items-center">
              <li>
      ...
      <div className="bg-blue-200">
        <div className="container mx-auto py-4 px-5 flex justify-center">
          <p className="text-gray-00 text-sm text-center sm:text-left">
            © 2023 Ramaio Store—
            <a
